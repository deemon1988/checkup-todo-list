import { highlightFields } from '../public/scripts/utils.js';
import { error_message } from '../public/scripts/utils.js';
import { sendFormRequest } from '../public/scripts/app.js';
...
reg_form.addEventListener('submit', async (event) => {
  ...
  const required_pass = await passValidation(password, confirmPassword);
